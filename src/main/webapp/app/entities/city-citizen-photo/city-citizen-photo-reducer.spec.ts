...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './city-citizen-photo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITYCITIZENPHOTO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CITYCITIZENPHOTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CITYCITIZENPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITYCITIZENPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITYCITIZENPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITYCITIZENPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITYCITIZENPHOTO actions', async () => {
      const expectedActions = [
        {
