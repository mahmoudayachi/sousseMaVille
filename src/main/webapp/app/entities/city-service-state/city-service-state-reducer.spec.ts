...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './city-service-state.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITYSERVICESTATE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CITYSERVICESTATES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CITYSERVICESTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITYSERVICESTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITYSERVICESTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITYSERVICESTATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITYSERVICESTATE actions', async () => {
      const expectedActions = [
        {
