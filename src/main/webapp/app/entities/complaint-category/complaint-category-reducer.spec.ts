...
import reducer, { getEntities, searchEntities, getEntity, reset } from './complaint-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPLAINTCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COMPLAINTCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COMPLAINTCATEGORY actions', async () => {
      const expectedActions = [
        {
