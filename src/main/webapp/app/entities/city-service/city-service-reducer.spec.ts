...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITYSERVICE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CITYSERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CITYSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITYSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITYSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITYSERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITYSERVICE actions', async () => {
      const expectedActions = [
        {
