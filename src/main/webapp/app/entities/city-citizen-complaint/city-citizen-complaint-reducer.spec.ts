...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './city-citizen-complaint.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITYCITIZENCOMPLAINT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CITYCITIZENCOMPLAINTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CITYCITIZENCOMPLAINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CITYCITIZENCOMPLAINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CITYCITIZENCOMPLAINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CITYCITIZENCOMPLAINT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CITYCITIZENCOMPLAINT actions', async () => {
      const expectedActions = [
        {
